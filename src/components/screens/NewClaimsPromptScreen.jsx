...
export default function NewClaimsPromptScreen({ veteranFirstName, onAnswer, onBack, progress }) {
  return (
    <ScreenWrapper>
      {progress !== undefined && (
      ...
      <div style={{ textAlign: 'center', marginBottom: '24px' }}>
        ...
        <h2 style={{
          ...
          {veteranFirstName}, do you want to file any new claims?
        </h2>
        <p style={{
          color: theme.gray,
          fontSize: '15px',
          ...
          Do you have any service-connected conditions that you're not currently rated for?
        </p>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '20px' }}>
        ...
        >
          Yes, I have new conditions to claim
        </button>
        <button
