...
export default function UnsureReassureScreen({ onContinue, onBack, progress }) {
  return (
    <ScreenWrapper>
      {progress !== undefined && (
      ...
      <div style={{ textAlign: 'center', marginBottom: '24px' }}>
        ...
        <p style={{
          ...
          The VA process can be confusing. Don't worry — we'll walk you through everything and help figure out where you stand.
        </p>
      </div>
