...
export default function CurrentConditionScreen({ onAnswer, onBack, progress }) {
  return (
    <ScreenWrapper>
      {progress !== undefined && (
      ...
      <div style={{ textAlign: 'center', marginBottom: '24px' }}>
        ...
        <h2 style={{
          ...
          Do you have a current illness or injury?
        </h2>
        <p style={{
          color: theme.gray,
          fontSize: '14px',
          ...
          This can be physical or mental, diagnosed or undiagnosed.
        </p>
      </div>
